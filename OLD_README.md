...
* run17 - track 2, architecture from run11, first batch of data
* run18 - track 2, architecture from run11, second batch of data
* run19 - track 2, architecture from run11, combined data from run17 and run18
